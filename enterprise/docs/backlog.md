...
| B-003 | P0 | 安装器 dry-run、失败清理和卸载验证 | 1/3 | done; Ubuntu 验收通过 |
| B-004 | P0 | ShellCheck、Bats 和基础 CI | 2/4 | done; CI 矩阵通过 |
| B-005 | P1 | fake/fixture 故障注入矩阵 | 3 | done |
| B-006 | P1 | tar.gz、artifact 内容检查和 SHA256 | 4 | done; main/tag/Release 一致 |
